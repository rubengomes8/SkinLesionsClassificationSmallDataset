...
# PERCEBER O IMPORT DATASET Q TA DIFERENTE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# ACHO Q JA PERCEBI - FAZER IMPORT DE TREINO OU VAL

p_train = '/home/ruben/Desktop/HierSmall/b'
t_train = '/home/ruben/Desktop/HierSmall/b/labels.csv'

p_val = '/home/ruben/Desktop/HierSmall/val/b'
t_val = '/home/ruben/Desktop/HierSmall/val/b/labels.csv'
...
def assign_labels(path_groundtruth):
    ...
    with open(path_groundtruth, 'r') as file:
        ...
        for row in reader:
            ...
            if row[1] == '1.0': # MEL
                #dict_labels_val[row[0]] = 'MEL'
                counter['MEL'] += 1
                target.append(0)
            elif row[2] == '1.0': # NV
                #dict_labels_val[row[0]] = 'NV'
                counter['NV'] += 1
                target.append(1)
    print(counter)
    file.close()
...
x_train = import_dataset(p_train, 'training', val=False)
y_train, counter = assign_labels(t_train)
print(counter)

# EM PRINCIPIO ESTA OK!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

n_0_float = float(counter['MEL'])
n_1_float = float(counter['NV'])
...
x_val = import_dataset(p_val, 'validation', val=True)
...
checkpoint_path = "/home/ruben/Desktop/Small/Hier/b/cp.ckpt"
