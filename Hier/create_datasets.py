...
write_labels_file_a('/home/ruben/Desktop/HierSmall/a/labels.csv')
...
write_labels_file_b(path_b+'/labels.csv')
...
write_labels_file_c(path_c+'/labels.csv')
...
write_labels_file_d(path_d+'/labels.csv')
...
write_labels_file_e(path_e+'/labels.csv')
